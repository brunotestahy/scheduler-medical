...
const scheduleServer = 'https://rdhcssmarthml01.rededor.corp/schedule_server';
...
export const environment = {
  ...
  carePlanPage: 'https://rdhcssmarthml01.rededor.corp/careplan',
  smartPage: 'https://rdhcssmarthml01.rededor.corp/smart/public/index.html',
  identificationPage: 'https://rdhcssmarthml01.rededor.corp/identification'
};
